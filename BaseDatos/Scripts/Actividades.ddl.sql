...
CREATE TABLE TB_ADM_PERMISOSXROL
  (
    ...
    NB_ACTIVO     NUMBER (2) ,
    NB_AGREGAR    NUMBER (2) ,
    NB_ELIMINAR   NUMBER (2) ,
    NB_ACTUALIZAR NUMBER (2)
  ) ;
...
CREATE TABLE TB_PERSONA
  (
    NB_Id                   NUMBER (15) NOT NULL ,
    NB_IdTipoIdentificacion NUMBER (3) NOT NULL ,
...
ALTER TABLE TB_CURSO ADD CONSTRAINT Curso_Curso_FK FOREIGN KEY ( NB_IdDependencia ) REFERENCES TB_DEPENDENCIA_ACADEMICA ( NB_Id ) ;
